      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
         <Stack direction="row" spacing={3} alignItems="center">
             {robotMode === 'AUTO' ? 
                ...
                <AdsClickIcon sx={{ color: '#00d4ff', fontSize: 40 }} />
             }
             <Box>
                 <Typography variant="h4" fontWeight="bold">Smart Control</Typography>
             ...
             <FormControlLabel
                ...
                label={
                  <Typography fontWeight="bold" color={robotMode === 'AUTO' ? '#00e676' : '#00d4ff'}>
                    {robotMode} MODE
                  </Typography>
                }
          ...
          <div style={{ position: 'relative', cursor: robotMode === 'AUTO' ? 'not-allowed' : 'crosshair' }}>
              <img 
                ...
                style={{ 
                    ...
                    height: 'auto', 
                    borderRadius: '8px',
                    boxShadow: robotMode === 'AUTO' ? '0 0 20px rgba(0, 230, 118, 0.2)' : '0 0 20px rgba(0, 212, 255, 0.2)',
              ...
              {lastClick && robotMode === 'MANUAL' && (
                  <div style={{
                      ...
                      width: 20, height: 20,
                      border: '3px solid #00d4ff', borderRadius: '50%',
                      pointerEvents: 'none', boxShadow: '0 0 10px #00d4ff'
                  }} />
              )}
          </div>
      </Box>
